...
def centralize(objects, dir):
    ...
    for object in objects:
        path_to_object= '../ressources_test1/'+object+'/'
        ...
        for index_dir, dir_subject in enumerate(list_dir): 
            ...
            if(dir == 'centralize'):
                ...
                for patch in list_patches:
                    ...
                    os.rename(path_to_object+dir_subject+"/patches/"+patch, path_to_object+dir+"/patches/"+patch2)
                    patch_path = path_to_object+dir_subject+"/patches/"+patch2
            
                    shutil.move(patch_path, '../'+dir+'/')
